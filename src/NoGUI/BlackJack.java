...
public class BlackJack {
    ...
    public static int getComputerBet(int cMoney, int pBet) {
        ...
        if (cMoney <= MIN_BET) {
            ...
            bet = random + pBet;
            if (cMoney < 1000) // Bets less if money is low, more if money is
                               // high
            {
                    ...
                    do {
                        ...
                        } else if (choice == 2) // stand
                        {
                            while (!cChoice.equals("stand") && !cChoice.equals("surrender") && cTotal <= 21) {
                                ...
                                // computer play
                                // ----------------------------cChoice =
                                // getComputerChoice(cTotal, cAce, c1, c2,
                                // cFirst);
                                cFirst = false;
    ...
    public static void slipHandComputer(int cardNum1, int cardNum2) // TODO
                                                                    // Check
                                                                    // Probability
    {
